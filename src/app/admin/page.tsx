...
import { Business, Location, MenuCategory, MenuItem } from "@/types";
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-xl border p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
              ...
              <input value={locForm.slug} onChange={(e) => setLocForm({ ...locForm, slug: e.target.value })} placeholder="URL slug (e.g. my-store-main)" className="border rounded-lg px-3 py-2 text-sm" />
            ...
            <>
              ...
              <div className="bg-white rounded-xl border p-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
                  ...
                  <input value={itemForm.price_cents} onChange={(e) => setItemForm({ ...itemForm, price_cents: e.target.value })} placeholder="Price in cents (e.g. 1299 = $12.99)" className="border rounded-lg px-3 py-2 text-sm" />
